...
const DEMO_CARDS: BusinessCard[] = [
  ...
  },
  {
    ...
    email: "mohamed@omari-construction.com",
    phone: "+212 661 23 45 67",
    website: "https://omari-construction.ma",
    bio: "30 ans d'expérience en projets d'infrastructure au Maroc et à l'international. Spécialiste des grands ouvrages et bâtiments institutionnels.",
    template: "omari",
    colorScheme: "gold-black",
    avatarUrl: null,
    socialLinks: {
      linkedin: "https://linkedin.com/in/mohamed-omari",
