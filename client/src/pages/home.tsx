...
const DEMO_COLLECTED_CARDS: BusinessCard[] = [
  {
    ...
    name: "MOURAD EL FAKIR",
    jobTitle: "CTO",
    company: "MarocChain",
    email: "mourad@marocchain.ma",
    phone: "+212 623456789",
    website: "https://marocchain.ma",
    bio: "Expert en solutions blockchain pour le secteur financier. Plus de 10 ans d'expérience en technologies décentralisées.",
    template: "bold",
    colorScheme: "amber-red",
    avatarUrl: null,
    socialLinks: {
      twitter: "https://twitter.com/mouradfakir",
